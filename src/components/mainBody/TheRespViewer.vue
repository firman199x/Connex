  ...
  <div class="main-body-sub-section">
    <div class="main-body-badge-area">
      ...
      <q-btn outline color="secondary" label="uid: 1" style="margin: 5px ;
        height: 1rem; border-radius:5px; " />
      <q-btn outline color="secondary" label="50MB" style="margin: 5px ;
        height: 1rem; border-radius:5px; " />
      <q-btn outline color="secondary" label="2 sec 12 ms 60 us" style="margin: 5px ;
        height: 1rem; border-radius:5px; " />
      <q-btn outline color="secondary" label="1/6" style="margin: 5px ;
        height: 1rem; border-radius:5px; " />
      <q-btn outline color="secondary" label="ReceivedTime: 23:13:15.532" style="margin: 5px ;
        height: 1rem; border-radius:5px; " />
    </div>
    <textarea v-model="respJson" class="my-textarea" readonly wrap="off" spellcheck="false" />
...
export default {
  setup() {
    const respJson = ref(JSON.stringify({
      "version": "1.0",
      "requestObjId": "",
